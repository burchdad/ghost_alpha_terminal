      ...
      <section className="relative mx-auto flex max-w-6xl flex-col gap-6 rounded-3xl border border-terminal-line bg-[#05121ab8] p-5 shadow-glow md:p-8">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-terminal-line/40 pb-4">
          <div className="flex flex-wrap items-center gap-2 text-[11px] uppercase tracking-widest">
            ...
            <span className="rounded-full border border-fuchsia-400/40 bg-fuchsia-400/10 px-3 py-1 text-fuchsia-300">
              AI Operator Copilot
            </span>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-6">
            <h1 className="text-3xl font-semibold leading-tight md:text-5xl">
              Trade With A
              <span className="mt-1 block text-terminal-accent">Mission-Driven AI Operator</span>
              <span className="mt-2 block text-base font-medium text-slate-300 md:text-xl">
                From market discovery to controlled execution in one command surface.
              </span>
            </h1>
        ...
        <div className="rounded-2xl border border-terminal-line/60 bg-black/20 p-5">
          <div className="mb-3 text-center text-[11px] uppercase tracking-wider text-slate-500">Final Step</div>
          <h2 className="text-center text-2xl font-semibold text-slate-100 md:text-3xl">Launch Your AI Trading Operator</h2>
